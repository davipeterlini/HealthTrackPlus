            ...
            <div className="flex flex-col">
              ...
              <div className="bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  <h3 className="font-medium text-slate-800 dark-text-title">{t('womensHealth.nextPeriod')}</h3>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-slate-800 dark-text-body">{t('womensHealth.headache')}</span>
                </div>
                <Badge className="bg-slate-100 text-slate-800 dark:bg-slate-700 dark:text-slate-300">
                  {t('womensHealth.none')}
                </Badge>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-slate-800 dark-text-body">{t('womensHealth.cramps')}</span>
                </div>
                <Badge className="bg-slate-100 text-slate-800 dark:bg-slate-700 dark:text-slate-300">
                  {t('womensHealth.none')}
                </Badge>
              ...
              <Button className="w-full mt-2 dark-btn-outline">
            ...
            <div className="space-y-3">
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
                <div className="flex items-start mb-1">
                  ...
                  <h3 className="font-medium text-sm text-slate-800 dark-text-title">{t('womensHealth.commonSymptoms')}</h3>
                </div>
