...
export function ExamResults({ examId }: ExamResultsProps) {
  ...
  if (!exam?.results) {
    return (
      <div className="px-4 py-5 sm:p-6 border-t border-gray-200">
        <h3 className="text-lg leading-6 font-medium text-gray-900">{exam?.name}</h3>
  ...
  return (
    <div className="px-4 py-5 sm:p-6 border-t border-gray-200">
      <h3 className="text-lg leading-6 font-medium text-gray-900">{exam.name} (Results)</h3>
        ...
        {sampleResults.map((result, index) => (
          <Card key={index} className="bg-gray-50">
            <CardContent className="px-4 py-5">
              ...
              <div className="text-xs text-gray-500 mt-1">Reference range: {result.referenceRange} {result.unit}</div>
            </CardContent>
          </Card>
        ))}
      </div>
