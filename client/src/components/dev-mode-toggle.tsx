...
export function DevModeToggle() {
  ...
  return (
    <Draggable handle=".drag-handle">
      <div className="fixed bottom-4 right-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg border z-50 flex flex-col">
        <div className="drag-handle flex items-center justify-between p-2 cursor-move border-b">
